...
function renderResult(result, searchTerms, titleTag) {
  ...
  if (result.title) {
    ...
    title.className = 'search-help-result-title';
...
function clearSearchResults(block) {
  const searchResults = block.querySelector('.search-help-results');
...
function searchResultsContainer(block) {
  ...
  results.className = 'search-help-results';
...
function searchInput(block, config) {
  ...
  input.className = 'search-help-input';
  input.placeholder = 'Help me with...';
  input.setAttribute('aria-label', 'Search help articles');
...
function searchBox(block, config) {
  ...
  box.classList.add('search-help-box');
